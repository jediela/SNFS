            ...
            <Card>
                <CardHeader>
                    <div className="flex justify-between items-center">
                        <CardTitle className="text-2xl">View Stock Lists</CardTitle>
                        {isLoggedIn && (
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <div className="bg-muted px-3 py-1 rounded-full text-sm">
                                        {list.access_type === 'owned' ? 'Private' : 
                                         list.access_type === 'shared' ? 'Shared with you' : 'Public'}
                                    </div>
                                </div>
                            </CardHeader>
                            <CardContent>
                ...
                <Card>
                    <CardContent className="py-8">
                        <p className="text-center text-muted-foreground">
                            No stock lists found. {!isLoggedIn && "Log in to see more lists or "} 
